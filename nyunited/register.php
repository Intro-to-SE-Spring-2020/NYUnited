...
<html>
<head>
	<title>Welcome to NYUnited!</title>
		...
		<div class="login_box">
			...
			<div id="first">
				<form action="register.php" method="POST">
					...
					<br>
					<?php if(in_array("Email or password is not correct<br>", $error_array)) echo "Email or password is not correct<br>"; ?>
			...
			<div id="second">
				<form action="register.php" method="POST">
					...
					else if(in_array("Your password must be between 5 and 30<br>", $error_array)) 
					...
					<?php if(in_array("<span style = 'color: #14C800'> You're all set ! Go agead and login</span><br>", $error_array)) 
						echo "<span style = 'color: #14C800'> You're all set ! Go agead and login</span><br>"; ?>
